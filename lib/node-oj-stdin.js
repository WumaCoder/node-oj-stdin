...
var array = require('src/transform/array');
var readline = require('readline');
var number = require('src/transform/number');
var tree = require('src/transform/tree');
...
function getLineArr() {
  return getLine().then(line => array.toArr(line));
}

function getLineInt() {
  return getLine().then(line => number.toNums(line));
}

function getBTree() {
  return getLine().then(line => tree.toBTree(line));
}
